...
#define USER_CLASSPATH "./build/classes;./lib/sqlite4java.jar;./lib/jcalendar-1.4.jar;./lib/mail.jar;./lib/RXTXcomm.jar;./lib/USBThermometerLib.jar;./lib/mysql-connector-java-5.1.18-bin.jar;"
...
int main(int argc, char* argv[]) {
     ...
     args = env->NewObjectArray(1 + argc, stringClass, jstr);
     if (args == NULL) {
     ...
     for(int i = 0; i < argc; i++) {
         ...
         if (args == NULL) {
            printf("Can't add a new Object to Array\n");
            goto destroy;
         }         
     }
